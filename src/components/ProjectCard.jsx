...
const ProjectCard = ({ project }) => (
  <a href={project.link} target="_blank" rel="noreferrer">
    <Flex
      ...
      overflow=""
      width="full"
      className="group hover:scale-105 hover:cursor-pointer transition-all duration-300 rounded-lg shadow-md mb-4 bg-white/70 dark:bg-gray-800/70 dark:hover:bg-gray-800 hover:bg-white"
    >
      <Box
        padding={4}
      ...
      <Box padding={4} className="w-full lg:w-3/4">
        <Box className="flex">
          <Box
            mb={2}
            className="lg:text-xl text-lg font-montserratMedium text-gray-700 dark:text-offwhite"
          >
            {project.title}
          </Box>
        ...
        <Box className="lg:text-sm text-xs font-montserratLight text-gray-600 dark:text-gray-300">
          {project.description}
        </Box>
