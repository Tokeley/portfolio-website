        ...
        <div>
            <PopoverRoot size={'xs'} open={open} onOpenChange={(e) => setOpen(e.open)}>
                <PopoverTrigger asChild>
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 24 24" fill="#374151" className='ml-2 hover:cursor-pointer transform transition-all duration-200 ease-in-out active:translate-y-1 active:scale-95 hover:scale-105'>
