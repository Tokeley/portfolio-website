...
const projects = [
  ...
  { title: "NOW Salt", description: "An internal use web application for NOW NZ to streamline client and service information retrieval for technical support staff. The app allows you to search for clients, and view what services they have as well as their broadband usage. The web app makes queires to a GraphQL endpoint in order to acess and update the client database.", technologies: ['React', 'GraphQL', 'MUI'], link: "", imageLink: "resources/now-salt.png" },
  ...
  { title: "Portfolio Website", description: "Wow, this is the website you are on right now. That is some website-ception. This portfolio website was made as a central hub where I can show case all my work. If you are wondering what the squiggle pattern in the background is, it is a dynamically generated flow field. Refresh the page and you will see it is a different pattern.", technologies: ['React', 'Tailwind', 'p5JS', 'Vercel'], link: "https://github.com/Tokeley/portfolio-website", imageLink: "resources/portfolio-website.png" },
  { title: "Lightspeed", description: "Lightspeed is an educational game with the aim of teaching young kids basic arithmetic. The game invloves flying a sapceship through the cosmos and surviving by lazering astroids. The game was created using the Pygame library and the pixel art was created by my friend George Hart. The game also invloves sound effects and background music I composed myself.", technologies: ['Python', 'Pygame'], link: "/light-speed.html", imageLink: "resources/lightspeed.png" },
