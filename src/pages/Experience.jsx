...
const experiences = [
  {
    ...
    description: `Working on hardware mapping. I contribute to the implementation and testing of a new mapping framework as well as general bug fixes.`,
...
const Experience = () => {
  ...
  return (
    <section id="Experience" className="h-full pt-24">
