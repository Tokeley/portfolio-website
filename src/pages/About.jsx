  ...
  return (
    <section id="About" className="section xl:h-screen h-full flex items-center justify-center py-32">
      <div className="flex items-center justify-center">
        <div className="h-full w-4/5 xl:flex  p-10 ">
          <div className='h-full xl:w-1/2 -800 mr-10 '>
              ...
              <div className='pl-2 w-full h-full '>
                {stats.map((stat, index) => (
                  <div className='flex py-2 items-center'>
                    <div className='w-1/4'>
                      <p className='text-2xl font-montserratLight text-gray-700 dark:text-offwhite'>{stat.label}</p>
                    </div>
                    <a key={index} a href={stat.link} target="_blank" rel="noopener noreferrer" className='w-3/4 flex hover:cursor-pointer items-center group'>
                      <p className='text-2xl font-montserratLight font-bold text-gray-700 dark:text-offwhite'>{stat.value}</p>
            ...
            <div className='xl:hidden w-full border-t-2 border-gray-400 dark:border-offwhite my-4'></div>
          </div>
          <div className='xl:border-r-2 border-gray-400 dark:border-offwhite'></div>
          <div className='h-full xl:w-1/2  ml-10'>
