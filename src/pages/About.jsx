...
const About = () => {
  return (
    <section id="About" className="section xl:h-screen h-full flex items-center justify-center py-32">
      <div className="flex items-center justify-center">
        <div className="h-full w-4/5 xl:flex  xl:p-8 ">
          <div className='h-full xl:w-1/2 -800 xl:mr-8 '>
            <h2 className='xl:text-6xl text-4xl font-montserratMedium text-gray-700 dark:text-offwhite p-2'>
              Hi, I'm Alex
            </h2>
            <p className='xl:text-xl text-lg font-montserratLight text-gray-700 dark:text-offwhite p-2'>
            ...
            <a href="https://www.google.com/maps/place/Auckland/@-36.8596971,174.5413126,11z/data=!3m1!4b1!4m6!3m5!1s0x6d0d47fb5a9ce6fb:0x500ef6143a29917!8m2!3d-36.8508827!4d174.7644881!16zL20vMDEydHM?entry=ttu&g_ep=EgoyMDI0MTIxMS4wIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noopener noreferrer" className='flex hover:cursor-pointer items-center group p-1'>
              <i className="fa fa-map-marker-alt text-gray-700 dark:text-offwhite xl:text-xl text-base"></i>
              <p className='ml-2 xl:text-xl text-base font-montserratMedium text-gray-700 dark:text-offwhite p-2'>
                Auckland, New Zealand
              </p>
              <i className="fa fa-arrow-right text-gray-700 dark:text-offwhite xl:text-xl text-base pl-2 transform translate-x-8 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300"></i>
            </a>
            <div className='w-full border-t-2 border-gray-400 dark:border-offwhite my-2'></div>
            <div className='w-full p-2'>
              <p className='mb-2 xl:text-xl text-base font-montserratMedium text-gray-700 dark:text-offwhite '>
                Currently I am...
              </p>
              <div className='pl-2 w-full h-full '>
                {stats.map((stat, index) => (
                  <div className='xl:flex py-1 items-center'>
                    <div className='xl:w-1/4'>
                      <p className='xl:text-lg text-sm font-montserratLight text-gray-700 dark:text-offwhite'>{stat.label}</p>
                    </div>
                    <a key={index} a href={stat.link} target="_blank" rel="noopener noreferrer" className='w-3/4 flex hover:cursor-pointer items-center group'>
                      <p className='xl:text-lg text-sm font-montserratLight font-bold text-gray-700 dark:text-offwhite'>{stat.value}</p>
                      <i className="fa fa-arrow-right text-gray-700 dark:text-offwhite xl:text-lg text-sm pl-2 transform translate-x-8 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300"></i>
                    </a>
                  </div>
                ))}
              </div>
            ...
            <div className='w-full border-t-2 border-gray-400 dark:border-offwhite my-2'></div>
            <a href="/resources/Alex_Manning_CV_2024.pdf" target="_blank" rel="noreferrer" className='flex hover:cursor-pointer items-center group p-1'>
                <i className="fa fa-file text-gray-700 dark:text-offwhite xl:text-xl text-base"></i>
                <p className='ml-2 xl:text-xl text-base font-montserratMedium text-gray-700 dark:text-offwhite p-2'>
                    Resume
                </p>
                <i className="fa fa-arrow-right text-gray-700 dark:text-offwhite xl:text-xl text-base pl-2 transform translate-x-8 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300"></i>
          ...
          <div className='xl:border-r-2 border-gray-400 dark:border-offwhite'></div>
          <div className='h-full xl:w-1/2  xl:ml-8 '>
            <p className='xl:text-base text-xs font-montserratLight pb-4'>
            ...
            <p className='xl:text-base text-xs  font-montserratLight font-light pb-4'>
